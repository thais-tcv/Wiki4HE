...
## Pacotes Necessários
#install.packages(c("descr", "likert"))

## Leitura dos dados
data = read.csv('C:/Users/Thaís Claudino/Desktop/DTi/wiki4HE.csv', sep = ";", header = T) #Altere o caminho para onde os dados estão guardados
str(data) # Temos 53 variáveis com 913 reas
